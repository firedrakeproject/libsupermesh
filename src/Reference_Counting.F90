...
!    USA
#include "fdebug.h"
module libsupermesh_reference_counting
  !! A module to implement reference counting on fields.
  use libsupermesh_fldebug
  use libsupermesh_global_parameters, only: FIELD_NAME_LEN, current_debug_level
  implicit none
...
end module libsupermesh_reference_counting
