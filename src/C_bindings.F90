module libsupermesh_c_interface
  ...
  public :: mesh_nelist_set_input_c, &
    & mesh_nelist_query_output_c, &
    & mesh_nelist_get_output_c, &
    & mesh_nnlist, &
    & mesh_nnlist_set_input_c, &
    & mesh_nnlist_query_output_c, &
    & mesh_nnlist_get_output_c, &
    & mesh_eelist_set_input_c, &
    & mesh_eelist_query_output_c, &
    & mesh_eelist_get_output_c, &
    & tree_intersection_finder_set_input_c, &
    & tree_intersection_finder_query_output_c, &
    & tree_intersection_finder_get_output_c, &
    & sort_intersection_finder_set_input_c, &
    & sort_intersection_finder_query_output_c, &
    & sort_intersection_finder_get_output_c, &
    & transpose_sparsity_c, &
    & intersect_tris_real_c, &
    & intersect_tets_real_c, &
    & triangle_area_c, &
    & tetrahedron_volume_c, &
    & intersect_intervals_c, &
    & interval_size_c, &
    & intersect_tri_quad_c, &
    & intersect_tet_hex_c
...
contains
  ...
  subroutine intersect_tet_hex_c( &
    ...
    real(kind = c_double), dimension(3, 4), intent(in) :: tet_a
    real(kind = c_double), dimension(3, 8), intent(in) :: hex_b
    real(kind = c_double), dimension(3, 4, 729), intent(out) :: tets_c
  ...
  subroutine intersect_tri_quad_c( &
    ...
    real(kind = c_double), dimension(2, 3), intent(in) :: tri_a
    real(kind = c_double), dimension(2, 4), intent(in) :: quad_b
    real(kind = c_double), dimension(2, 3, 46), intent(out) :: tris_c
  ...
  subroutine sort_intersection_finder_set_input_c( &
    ...
    real(kind = c_double), dimension(dim_a, nnodes_a), intent(in) :: positions_a
    integer(kind = c_long), dimension(loc_a, nelements_a), intent(in) :: enlist_a
    real(kind = c_double), dimension(dim_b, nnodes_b), intent(in) :: positions_b
  ...
  subroutine intersect_intervals_c( &
    ...
    real(kind = c_double), dimension(2), intent(in) :: interval_a
    real(kind = c_double), dimension(2), intent(in) :: interval_b
    real(kind = c_double), dimension(2), intent(out) :: intervals_c
  ...
  subroutine interval_size_c(interval, size) &
    ...
    real(kind = c_double), dimension(2), intent(in) :: interval
    real(kind = c_double), intent(out) :: size 
  ...
  subroutine tetrahedron_volume_c(tet, volume) &
    ...
    real(kind = c_double), dimension(3, 4), intent(in) :: tet
    real(kind = c_double), intent(out) :: volume 
  ...
  subroutine triangle_area_c(tri, area) &
    ...
    real(kind = c_double), dimension(2, 3), intent(in) :: tri
  ...
  subroutine intersect_tets_real_c( &
    ...
    real(kind = c_double), dimension(3, 4), intent(in) :: tet_a
    real(kind = c_double), dimension(3, 4), intent(in) :: tet_b
    real(kind = c_double), dimension(3, 4, tet_buf_size), intent(out) :: tets_c
    integer(kind = c_int), intent(out) :: n_tets_c
  ...
  subroutine intersect_tris_real_c( &
    ...
    real(kind = c_double), dimension(2, 3), intent(in) :: tri_a
    real(kind = c_double), dimension(2, 3), intent(in) :: tri_b
