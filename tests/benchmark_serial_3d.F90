subroutine benchmark_serial_3D
...
#include <finclude/petsc.h90>
  ...
  integer :: ele_A, ele_B, ele_C, i, ierr, nprocs, n_tetsC, rank, serial_ele_A, serial_ele_B
...
!          integral_serial = integral_serial + valsB(ele_B) * triangle_area(tetsC(ele_C)%v)
        end do
      end do
    end do
...
end subroutine benchmark_serial_3D